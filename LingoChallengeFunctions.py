...
def langSelec():  # prompting user to select a language for the quiz
...
def diffLevel():  # three levels of difficulties available for the quiz, making sure that user inputs 1, 2 or 3
    print("Please select a difficulty level.")
    print("1. Word level")
    print("2. Sentence level")
    print("3. Paragraph level")
    diff_level = input("Enter the level of difficulty you want to select: ")
    while diff_level != "1" and diff_level != "2" and diff_level != "3":
        print("Please enter a valid number.")
        diff_level = input("Enter the level of difficulty you want to select: ")
    print("")
    return diff_level

def numQuest(): # question minimum and limit that user can select for quiz.
    # The limit is based on how many words are in the txt files
...
def wordTranslation(testLanguage, englishTranslate, numQuestions):  # user have to input the English translation
    # of words in a selected language. Each correct answer receive a score of 3
    try:
...
def testSelec(selected_language, difficultyLevel, numQ):
    if selected_language == "1" and difficultyLevel == "1":
        try:
            wordTranslation("FrenchWords.txt", "EnglishWords.txt", numQ)
        except FileNotFoundError:
            print("Error: The required file for the French word quiz is not found.")

    elif selected_language == "1" and difficultyLevel == "2":
        try:
    ...
    elif selected_language == "1" and difficultyLevel == "3":
        try:
            paragraphTranslation("FrenchParagraphs.txt", "EnglishParagraphs.txt", numQ)
        except FileNotFoundError:
            print("Error: The required file for the French sentence quiz is not found.")

    elif selected_language == "2" and difficultyLevel == "1":
        try:
    ...
    elif selected_language == "2" and difficultyLevel == "2":
        try:
    ...
    elif selected_language == "2" and difficultyLevel == "3":
        try:
